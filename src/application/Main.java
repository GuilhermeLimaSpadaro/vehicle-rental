				...
				case 2:
					...
					while (optionCarMenu != 0) {
						...
						case 1:
							...
							input.nextLine();
							Vehicle vehicleCar = new Car(idCar, mark, model, ano, value, door,
						...
						case 2:
							...
							wHP = input.nextInt();
							input.nextLine();
							Vehicle vehicleMoto = new MotorCycle(idMotocycle, mark, model, idMotocycle, value, door,
									new Engine(wHP, engineType));
						...
						case 3:
							...
							wHP = input.nextInt();
							input.nextLine();
							Vehicle vehicleTruck = new Truck(idTruck, mark, model, idTruck, value, door,
									new Engine(wHP, engineType));
