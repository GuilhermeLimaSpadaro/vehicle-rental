	...
	public static void main(String[] args) throws DomainException, VehicleServiceException {
		...
		try (Scanner input = new Scanner(System.in)) {
			...
			while (carMenu != 0) {
				...
				System.out.println("4. Mostre informacoes do usuario.");
				System.out.println("5. Mostre infomacoes do veiculo.");
				System.out.println("6. Buscar veiculo.");
				System.out.println("0. Sair.");
				System.out.print("\nEscolha uma das opcoes: ");
				carMenu = input.nextInt();
				input.nextLine();

				if (carMenu < 0 || carMenu > 6) {
				...
				case 2:
					...
					while (optionCarMenu != 0) {
						...
						case 1:
							...
							input.nextLine();
							Vehicle vehicleCar = new Car(idCar, mark, model, year, value, door, wHP, engineType);
						...
						case 2:
							...
							wHP = input.nextInt();
							input.nextLine();
							Vehicle vehicleMoto = new MotorCycle(idMotocycle, mark, model, year, value, door, wHP, engineType);
						...
						case 3:
							...
							wHP = input.nextInt();
							input.nextLine();
							Vehicle vehicleTruck = new Truck(idTruck, mark, model, year, value, door, wHP, engineType);
				...
				case 3:
					...
					System.out.print("Modelo: ");
					String model = input.nextLine();
					vehicleInterface.removeCar(model);
					break;
				case 4:
